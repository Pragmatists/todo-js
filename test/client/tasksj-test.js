...
//END:GETELEMENT    
   ...
   responseStub = JSON.stringify([
     {id: '123412341201', name: 'task a', month: 8, day: 1, year: 2016},
     {id: '123412341202', name: 'task b', month: 9, day: 10, year: 2016},
     {id: '123412341203', name: 'task c', month: 10, day: 11, year: 2017},
   ]);
...
//END:GETELEMENT    
 ...
 it('jGetTasks should call jCallService', function(done) {
   sandbox.stub(window, 'jCallService').callsFake( function(params) {
     ...
     expect(params.url).to.contain('/tasks');
     done();
   });
...
//END:READY_TEST
 ...
 it('deleteTask should call jCallService', function(done) {
   sandbox.stub(window, 'jCallService').callsFake( function(params) {
     ...
     expect(params.url).to.contain('/tasks/123412341203');
     done();
   });
